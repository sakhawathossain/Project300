...
<html>
    <head>
        ...
        <script src="<c:url value="/resources/javascript/tasks.js" />" type="text/javascript" ></script>
...
<!-- TABLE -->
        ...
        <div class="modal fade" id="modalTaskInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-1"><p id="view_task_id"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-3"><label>Title</label></div>
                            <div class="col-md-3"><p id="view_task_title"></p></div></div>
                        <div class="row">
                            <div class="col-md-1"><label>Type</label></div>
                            <div class="col-md-1"><p id="view_task_type"></p></div></div>
                        <div class="row">
                            <div class="col-md-1"><label>Description</label></div>
                            <div class="col-md-1"><p id="view_task_description"></p></div>
                        </div>
                        <div class="row">
                            <div class="col-md-2"><label>Deadline</label></div>
                            <div class="col-md-2"><p id="view_task_deadline"></p></div>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-2"><label>Total Group</label></div>
                            <div class="col-md-2"><p id="view_task_total_group"></p></div>
                        </div>
                        
                        <div class="row">
                            <div class="col-md-2"><label>Total Submission</label></div>
                            <div class="col-md-2"><p id="view_task_total_submission"></p></div>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="modalTaskEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form id="edit_task" name="edit_task" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row bottom-buffer">
                                ...
                                <div class="col-md-8"><textarea name="taskDesc" id="edit_task_description" type="text" class="form-control"></textarea></div>
                            </div>
                            ...
                            <div class="row bottom-buffer">
                                <div class="col-md-8 col-md-offset-4"><input type="checkbox" name="isOpen" id="edit_task_sopen" value="true" checked> Submissions open<br>
                                </div>
                            </div>
        ...
        <div class="modal fade" id="modalTaskDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
